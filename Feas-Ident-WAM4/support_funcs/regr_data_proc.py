...
def gen_regr_matrices(rbt, q, dq, ddq, tau):
    ...
    exec(spb.robot_code_to_func( 'python', rbt.H_code, 'H', 'regressor_func', rbt.rbtdef), globals())
    # cpp_code = spb.robot_code_to_func( 'c', rbt.H_code, 'H', 'regressor_func', rbt.rbtdef)
    # print(cpp_code)
    global sin, cos, sign
    sin = numpy.sin
    cos = numpy.cos
